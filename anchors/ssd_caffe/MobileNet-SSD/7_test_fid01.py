...
def draw_bbox_on_image(nxmin,nymin,nxmax,nymax, img_filepath):
    ...
    rect_img_savepath = "example/res_fid01_1/"+os.path.splitext(tmp_filepath)[0]+"_rec.jpg"
...
if __name__ == '__main__':
    ...
    model_weights = 'snapshot/86/mobilenet_iter_105000.caffemodel'
    ...
    transformer.set_raw_scale('data', 255)  # the reference model operates on images_fid01 in [0,255] range instead of [0,1]
    ...
    #image = caffe.io.load_image('example/images_fid01/ch00005_20190303_ch00005_20190303105000.mp4.cut.mp4_001500_crop_0.jpg')
    #image = caffe.io.load_image('example/images_fid01/ch01014_20190322_ch01014_20190322084500.mp4.cut.mp4_000000_crop_4.jpg')
    jpgs = list_all_files("example/images_fid01", exts=["jpg"])
    for jpg_img in jpgs:
