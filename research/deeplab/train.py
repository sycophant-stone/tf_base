...
def main(unused_argv):
  ...
  with tf.Graph().as_default() as graph:
    with tf.device(config.inputs_device()):
      ...
      print("[train]: train_crop_size:",FLAGS.train_crop_size)
      print("[train]: train_batch_size:",FLAGS.train_batch_size)
      print("[train]: min_resize_value=min_resize_value:",FLAGS.min_resize_value)
      print("[train]: max_resize_value=max_resize_value:",FLAGS.max_resize_value)
      print("[train]: resize_factor=resize_factor:",FLAGS.resize_factor)
      print("[train]: min_scale_factor=min_scale_factor:",FLAGS.min_scale_factor)
      print("[train]: max_scale_factor=max_scale_factor:",FLAGS.max_scale_factor)
      print("[train]: scale_factor_step_size=scale_factor_step_size:",FLAGS.scale_factor_step_size)
      print("[train]: dataset_split:",FLAGS.train_split)
      print("[train]: is_training=",True)
    ...
    with tf.device(config.variables_device()):
      ...
      print("tf.GraphKeys.UPDATE_OPS: update_ops",update_ops)
