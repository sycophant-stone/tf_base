...
def train(create_tensor_dict_fn, create_model_fn, train_config, master, task,
  ...
  with tf.Graph().as_default():
    ...
    slim.learning.train(
[train_tensor,tfprint.tfp_similarity_matrix,tfprint.tfp_match_results,tfprint.anchors,tfprint.groundtruth_boxes,tfprint.cls_targets,tfprint.matches_raw],
        logdir=train_dir,
        master=master,
        is_chief=is_chief,
