...
import os
import sys
sys.path.insert(0,'/ssd/hnren/tf/1sd/1_lf/lfcaffe/caffe/python')
import cv2
import time
import decimal
import argparse
...
if __name__ == '__main__':
    ...
    for jpg_img in jpgs:
        ...
        start =time.time()
        # Forward pass.
        detections = net.forward()['conv_box']
        concatout = net.forward()['concat_out']
        end =time.time()
        print('Running time: {} Seconds'.format(end-start))
        print("detections:",dedections)
