...
if __name__ == '__main__':
    ...
    jpgs = list_all_files("/ssd/hnren/tf/1sd/MobileNet-SSD/example/all_imgs", exts=["jpg"])
    ...
    for jpg_img in jpgs:
        ...
        xml_sample_path = "/ssd/hnren/tf/1sd/caffe/data/5_patches300to72_INT/HeadVocFormat/FID_DID_HEAD_CLEAN_0_patches_int/Annotations/"+xml_temp+".xml"
    ...
    print(match)
    fppi_res = calculate_fppi(match, [0.04])
    print(fppi_res)
